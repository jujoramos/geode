...
public class QueryServiceJUnitTest {
  ...
  public void toDateWithPresetDateShouldExecuteWithoutExceptions() throws Exception {
    ...
    Query query = queryService.newQuery("SELECT * FROM /Portfolios WHERE createDate >= to_date('" + testDate
          + "', 'MM/dd/yyyy')");
    query.execute();
  }
  ...
  public void toDateWithValidBindParameterDateShouldExecuteWithoutExceptions() throws Exception {
    String testDate = "01/01/2000";
    QueryService queryService = CacheUtils.getQueryService();
    Query query = queryService.newQuery("SELECT * FROM /Portfolios WHERE createDate >= to_date($1, 'MM/dd/yyyy')");
    query.execute(testDate);
  }

  @Test
  public void toDateWithInValidStringBindParameterDateShouldThrowQueryInvalidException() throws Exception {
  ...
  @Test
  public void toDateWithRegionAsBindParameterDateShouldThrowQueryInvalidException() throws Exception {
