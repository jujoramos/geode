...
public class ObjectTypeAssert extends AbstractAssert<ObjectTypeAssert, ObjectType> {
  ...
  public ObjectTypeAssert isCollectionOf(Class componentType) {
    ...
    org.assertj.core.api.Assertions.assertThat(((CollectionTypeImpl) actual).getElementType()).isExactlyInstanceOf(componentType);
  ...
  public ObjectTypeAssert isMapOf(Class keyType, Class valueType) {
    ...
    org.assertj.core.api.Assertions.assertThat(((MapTypeImpl) actual).getKeyType()).isExactlyInstanceOf(keyType);
    org.assertj.core.api.Assertions.assertThat(((MapTypeImpl) actual).getElementType()).isExactlyInstanceOf(valueType);
